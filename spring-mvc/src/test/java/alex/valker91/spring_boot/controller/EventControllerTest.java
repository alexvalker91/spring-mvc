...
class EventControllerTest {
	...
	@Test
	void getEventsMainPage_returnsTemplate() throws Exception {
	...
	@Test
	void createEvent_success_redirectsToEvent() throws Exception {
	...
	@Test
	void createEvent_parseError_returnsFormWithErrors() throws Exception {
		mockMvc.perform(post("/events/create")
					.param("id", "0")
					.param("title", "Conf")
					.param("date", "bad-date")
	...
	@Test
	void getEventsForDay_badDate_setsBadRequestAndReturnsListView() throws Exception {
