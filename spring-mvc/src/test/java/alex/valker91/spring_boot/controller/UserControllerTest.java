...
class UserControllerTest {
    ...
    @Test
    void getUsersMainPageReturnsTemplate() throws Exception {
    ...
    @Test
    void createUserSuccessRedirectsToUser() throws Exception {
    ...
    @Test
    void createUserValidationErrorReturnsFormWithErrors() throws Exception {
    ...
    @Test
    void getUserRendersUserView() throws Exception {
        when(bookingFacade.getUserById(123)).thenReturn(new UserImpl(123, "Bob", "bob@example.com"));
