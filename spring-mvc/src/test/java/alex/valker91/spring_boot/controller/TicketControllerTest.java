...
class TicketControllerTest {
    ...
    @Test
    void getTicketsMainPageReturnsTemplate() throws Exception {
    ...
    @Test
    void createTicketSuccessRendersNewTicketWithModel() throws Exception {
    ...
    @Test
    void createTicketInsufficientFundsReturnsFormWithError() throws Exception {
    ...
    @Test
    void cancelTicketSetsModelAndReturnsView() throws Exception {
