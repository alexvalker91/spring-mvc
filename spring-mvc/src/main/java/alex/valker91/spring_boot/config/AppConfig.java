...
public class AppConfig {
    ...
    public BookingFacade bookingFacade(EventService eventService,
                                       ...
                                       @Value("classpath:tickets.xml") org.springframework.core.io.Resource defaultTicketsResource) {
        return new BookingFacadeImpl(eventService, ticketService, userService, userAccountService,
                ticketsMarshaller, transactionTemplate, defaultTicketsResource);
    }

    @Bean
    public Jaxb2Marshaller ticketsMarshaller() {
        Jaxb2Marshaller marshaller = new Jaxb2Marshaller();
        marshaller.setClassesToBeBound(TicketsXml.class);
        return marshaller;
    }
